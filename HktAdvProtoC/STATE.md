...
- **F-3** §23 관찰 채널 8/12(촉각·열·문서 없음) · **F-4** §24 `betrayal` 기억 생산 경로 없음 · **F-5** §21 "방어한다" 행동 부재(20/21) · **F-6** §17 제도(structures/policies) 타입 부재 · **F-7** §16 실패 반동이 언제나 자기 자신에게만(대상 선택자 없음) · **F-8/F-9** 검사기 수 주석 드리프트(15종→실제 17종) · smoke 의 선행 빌드 미안내.
- 판정이 내려온 절: §16 · §24 · §33 (1차의 "편차·주의"를 실물로 확인해 부분으로 계상). 올라간 절: §19 · §41 · §7 · §8 · §12 · §13 · §14 · §15 · §18 · §25 · §29 · §32.
