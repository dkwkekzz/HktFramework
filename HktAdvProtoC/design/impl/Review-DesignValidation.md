...
>
> 갱신 이력: G-2(§5) · G-3(§6) · G-1(§7) · G-10(§8) · G-5(§9) 수정 완료 — §1 표와 §2 갭 목록에 표시를 달았다. 아래 §0 의 수치는 **검증 시점(2026-07-28)** 의 것이고, 최신 수치는 각 수정 절에 있다.
...
- 후속 작업 우선순위 제안: ~~G-2(사회 행동+신호 발신)~~ → ~~G-3(hiddenPurposes 소비)~~ → ~~G-1(확률 용도 검증)~~ → ~~G-10(게이트 항진 항, 즉효)~~ → **G-4/G-5(종족·공간 필드 소비)**. *G-1~G-3·G-10 은 §5~§8 에서 수정 완료.*
