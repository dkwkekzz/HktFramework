...
묶음이 세우는 로드맵의 행이 Cycle 의 종류를 정한다 ([content/roadmap/README.md](../content/roadmap/README.md) §1 — 층은 둘이다).
...
| 경험 | **판정하지 않는다.** 경험을 가르는 것은 손잡이로 내려간다 — 기본값을 두고 손잡이 목록에 적는다. "읽히는가 · 느껴지는가 · 이 값이 맞는가" 는 그 축을 처음 쓰는 컨텐츠 묶음이 묻는다 | Breath · 관찰 항목 · 실주행 |
