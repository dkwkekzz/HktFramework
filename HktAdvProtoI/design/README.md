...
| `Plan-Place-Observation-Surface.md` | **자리를 관찰하는 표면** (승인 — C026~C028 이 회수했다) — 세계에 뿌리는 글자를 어디에 둘 것인가 · 관찰 상호작용 · 기존 지목(TG) 기반과의 겹침 판정 |

## 묶음

기획서와 Cycle 사이에 문서 층은 없다. 기획서에서 자른 플레이 하나(묶음 — Goal · Intent · Breath · Cycle 목록 · 미지 · 질문)는
첫 Cycle 의 `cycles/C###/spec.md` 머리 블록이고, "C### 진행" 이 승인이다 (Design-DesignAuthoringWorkflow.md §5~§7).
묶음 하나는 로드맵의 열린 층 하나만 세운다.
