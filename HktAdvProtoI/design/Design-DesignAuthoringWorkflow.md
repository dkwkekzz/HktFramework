...
체크박스 목록으로 관리한다 (`[ ] C021 — 생물의 위험 감지와 도주`).
...
초안을 작성하고 Human 이 Play Goal · Experience Intent · Breath · Cycle 범위를
승인하는 **공동 문서**다 — 승인 전에는 Cycle 을 시작하지 않는다. 승인 후 Agent 가
play 문서를 만질 수 있는 자리는 Cycle Breakdown 체크박스 갱신(§8)뿐이다.
