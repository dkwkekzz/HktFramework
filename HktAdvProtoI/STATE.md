...
**Play 실주행 판정 — 다섯은 답이 반영되었고 하나가 대기한다** — Human 판정은 Cycle 이 아니라 **Play 단위**이고, Human 은 항목 전부가 아니라
...
|---|---|---|
| RoomBecomesLand | 능선에 막히고 강에 막히고 다리로 건넌다 — **판정 반영됨** (막힘이 말을 한다 · 거목의 줄기) | Q6′ · Q7′ 재확인 |
| RuleBoundRoom | 규칙을 관찰해 심장에 닿고, 두 번째 관찰자가 같은 미로를 본다 — **판정 반영됨** (규칙의 힌트 · 임박 · 닫힌 길의 이름) | Q11′ 재확인 |
| RoomBearsMaterial | 흔적에서 원천으로, 캔 자국이 남고, 균류를 캔 것이 거목 쪽 회복을 늦추며, 되돌아온 원천은 다음 마디에 선다 — **판정 반영됨** (흩어진 것 셋 · 밤에만 서는 것) | Q15′ 재확인 |
| RoomAnswersWhenAsked | 세계 위 글자 없이, 물어서 자리와 존재를 읽고 그 답이 남는다 — **판정 반영됨** (시점 상하 25°~45°) | — |
| RoomNeverSame | 고요에 왔다 스밈에 다시 와 깊어진 자락을 보고, 긴 밤의 문을 지나 눈 없는 것을 피하고, 뒤척임 뒤에 옮겨 간 원천과 남의 발자국을 보며, 셋이 함께 올린 소란이 방을 깨우고 그것이 경로를 휘게 한다 — **판정 반영됨** (철의 자락이 땅에 선다 · 철을 타는 방 일곱 · 때가 바뀐 한 마디) | Q25′ 재확인 |
