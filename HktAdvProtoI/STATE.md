...
화면 — 세계의 사실이 세계 위 글자·상시 HUD 로 늘 선불된다 (백왕령 한 화면에 글자 다섯 · 같은 조건이 두 자리에 중복).
검토와 제안은 [design/Plan-Place-Observation-Surface.md](design/Plan-Place-Observation-Surface.md) — 승인 대기.
