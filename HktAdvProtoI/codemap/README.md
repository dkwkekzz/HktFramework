...
```text
쓰는 이     advprotoi-cycle 명세 단계 — Existing 판정(이미 있는 기구 · State · 표)은 여기 + 기존 cycles/*/spec.md 의 ADDED 로 한다. 코드는 보지 않는다.
           advprotoi-design — Play 의 Required Capability 를 Existing / Required 로 가를 때.
