// World Semantic — Actor.CurrentAction · ActionKind · ActionDefinition
//
...
export const ACTION_DEFINITIONS: Readonly<Record<ActionKind, ActionDefinition>> = {
  ...
  // 스킬의 duration 은 여기 값이 아니라 시작하는 순간의 공격 속도가 정한다 —
  ...
  // 쓰러짐 — 스스로 끝나지 않고 대체되지도 않는다 (INTENT-DOWNED-001)
