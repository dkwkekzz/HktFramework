// World.CommandCatalog — Implements INTENT-COMMAND-CATALOG-001
//
...
// 가 MUTABLE_ATTRIBUTES 에 내린 판단과 같은 판단이며, 그것을 명령 전체로 넓힌다.
//
// 세계 안의 행동(Interaction — 이동·채굴·스킬)과 다른 것이다.
// Interaction 은 몸이 세계 안에서 하는 일이고, Command 는 세계의 규칙 밖에서
// 세계에 손을 대는 일이다 (RULE-ATTRIBUTE-SET-001 주석의 표현 그대로).
//
...
// 선택지 목록도 각 범위도 MUTABLE_ATTRIBUTES 가 단일 출처다.
