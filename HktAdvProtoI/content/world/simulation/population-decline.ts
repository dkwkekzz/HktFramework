...
// Scope          모든 방의, **요구(declineWhen)를 밝힌** 개체군 전부
// Trigger        세계의 Tick
...
//                ② 지난 철마다: metThisSeason 이 거짓인 개체군은 값 -= 1 (0 미만 없음) ·
//                   그리고 metThisSeason 을 거짓으로 되돌린다.
//                   그 뒤 World.seasonsApplied 를 지금까지 바뀐 수로 맞춘다
// Result         (없음 — 세계가 마를 뿐이다. 무엇이 달라졌는지는 선 자락의 넓이와
//                 멎은 원천의 사유가 말한다 · spec Observable)
//
...
/**
 * 철 하나가 지나갔다 — 못 찬 개체군의 값이 1 준다 (spec R3 · SPEC-003 ② ③).
 *
