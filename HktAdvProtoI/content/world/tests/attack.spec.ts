...
// Implements INTENT-ATTACK-001 · INTENT-ATTACK-HIT-001 ·
//            INTENT-HIT-REACTION-001 · INTENT-BODY-FACING-001(R1)
//
// 타격은 완료 순간이 아니라 휘두름 구간 [SWING_BEGIN, SWING_END] 의
...
describe('RULE-SKILL-BEGIN-001 — 대상 없이 휘두른다 (구 RULE-ATTACK-001)', () => {
...
describe('RULE-SWING-STRIKE-001 — 휘두름 구간의 칼끝 접촉이 정한다', () => {
  ...
  it('물러서는 중이어도 구간에 접촉했으면 맞는다 (완료 순간 판정이 아니다)', () => {
