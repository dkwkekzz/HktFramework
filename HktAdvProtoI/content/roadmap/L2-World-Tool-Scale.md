...
| 지역 하나를 쓰는 공식은 고정돼 있다 — Concept §17 일곱 질문 · Region §15 12단계 · 재료 계약 표 다섯 · 철 덧씌움 넷 · 생명 계약(탄생지 · 개체군 · 관계) · 접근 계약(Lock · 성질 · 흔적 · 답의 종류) · 기회 계약(기회 · 기억 · 조건의 한 형) · 검사 ①~㊼ | ① ② ②-부속 다섯 |

공식이 고정됐다는 것은 **생성기가 돌릴 수 있다**는 뜻이다. 기획 여섯이 무거웠던 이유는 그것이 지역이 아니라 **문법**이었기
때문이고, 문법은 이제 닫혔다. 생명 계약([L2-World-Life.md](L2-World-Life.md) §3.5)과 접근 계약([L2-World-Access.md](L2-World-Access.md) §5.4)과 기회 계약([L2-World-Foundation.md](L2-World-Foundation.md) §5.4 — 무엇이 기반이고 무엇이 조합인지를 가르는 결정 나무도 여기서 온다)이 이 공식에 마지막으로 든 항이다 —
