...
2층의 Play 는 여섯이다 (`play/README.md`) — **전부 승인됐다**. 여섯째(`play/RoomAnswersWhenAsked.md`)는
새 축이 아니라 앞선 Play 의 실주행에서 돌아온 DESIGN GAP 의 회수다 — 화면(8층)은 여전히 "별도 주입 없음" 이고,
