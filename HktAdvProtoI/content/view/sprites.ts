...
const PALETTE: Record<string, string> = {
  ...
  // 하늘에서 떨어진 것의 두 색 (C018) — 이 세계의 어느 것과도 계통이 다르다.
  // 숲의 색은 붉거나 따뜻하고(C·c·m·k·u·U) 이것만 **차갑고 옅다**: 땅에서 난 것이 아니라
  // 위에서 온 것이라는 게 색 하나로 먼저 읽힌다 (Concept §9)
  // 스물여섯 글자가 다 찼으므로 숫자로 간다 — 색을 줄이는 것보다 글자를 늘리는 것이 옳다
  '1': '#dfe7f0', // 비늘의 면 (볕) — 이 표에서 가장 밝다
  '2': '#9aabc0', // 비늘의 결 (그늘)
  ...
  // 추위가 만든 것의 색 셋 (C020) — 협곡의 원천 넷이 이 셋을 함께 쓴다. 사다리는 붉은 것의
  // 그것 그대로다 (볕 → 그늘 → 땅에 닿는 밑동 = C·c·G 와 같은 자리).
  //
  // **계통이 색에서 먼저 갈린다** — 숲의 재료는 붉고(C·c·G), 물빛은 청록으로 누웠으며(V·Z),
  // 하늘에서 온 것은 채도가 없이 옅다(1·2). 빙정석만 **채도가 선 파랑**이다: 푸르게 빛나고
  // 닿은 것을 식힌다 (Play 확정 3).
  //
  // 밝기의 근거 — 이것이 서는 바닥은 서리(SURFACE_FROST 0xbcd0ec · 아주 밝은 옅은 파랑)와
  // 급경사 벽(SURFACE_STEEP 0xa8a49c · 무채색)이므로, 그 위에서 보이려면 **바닥보다 진하고
  // 채도가 높아야** 한다. 협곡의 흔적(TRACE_FROST_BREATH_COLOR 0x3b3a8c · 남보라)과도
  // 갈리도록 색상을 청록 쪽으로 눕혔다 — 흔적은 바닥에 배는 색이고 이것은 그 위에 선 것이다.
...
// ── 지나간 것이 남긴 것 둘 (C018) ─────────────────────────────────────
//
// 앞의 여덟은 **그 방이 낳은 것**이라 땅에서 솟거나 깔려 있다. 이 둘은 **지나간 것이 두고 간
// 것**이라 그 자리에 놓여 있을 뿐이다 — 밑동도 뿌리도 없다. 그것이 실루엣에서 먼저 갈린다.

// 떨어진 비늘 — 한 장이 비스듬히 꽂혀 있다. 넓고 얇고 **차갑게 밝다**: 땅에서 난 것이
// 아니라 하늘에서 온 것이다 (Concept §9). 이 세계에서 가장 밝은 그림이다
const SOURCE_FALLEN_SCALE = [
  '................',
  '.........11.....',
  '........1111....',
  '.......112111...',
...
// 캐 간 자리 — 비늘은 없고 그것이 꽂혀 있던 얕은 골과 부스러기 몇 점만 남는다.
// **밝은 것이 사라지는 것**이 available 과 갈리는 자리다
const SOURCE_FALLEN_SCALE_DEPLETED = [
  '................',
  '................',
  '................',
  '................',
...
// 되돌아오는 중 — 이 원천에는 오지 않는 자리다 (되돌리는 것은 시간이 아니라 다시 지나가는
// 것이므로 진행이 오르지 않는다). 그래도 표를 비워 두지 않는다: 규칙이 닿을 수 있는 state 는
// 셋이고, 비워 두면 그날 화면이 물음표를 그린다. 골에 결 한 조각이 돌아온 그림이다
const SOURCE_FALLEN_SCALE_RECOVERING = [
  '................',
  '................',
  '................',
  '................',
...
// 먹이 잔해 — 눈 없는 것이 먹고 남긴 껍질. **허물과 같은 계통이라 같은 색**이고(m·k·x)
// 흩어진 조각이라는 것도 같다. 갈리는 것은 놓임이다: 허물은 나무 밑동에 쌓이고 이것은
// 지나간 자리에 **길게 끌린 자국**으로 흩어진다
const SOURCE_PREY_REMAINS = [
  '................',
  '................',
  '................',
  '.....mkx........',
...
// 거둬 간 자리 — 조각이 거의 없고 마른 자국(g·e)만 길게 남는다
const SOURCE_PREY_REMAINS_DEPLETED = [
  '................',
  '................',
  '................',
  '................',
...
// 되돌아오는 중 — 위와 같은 이유로 비워 두지 않는다. 마른 자국 위에 조각 몇이 돌아온 그림
const SOURCE_PREY_REMAINS_RECOVERING = [
  '................',
  '................',
  '................',
  '................',
...
// ── 추위가 만든 것 넷의 그림 열둘 (C020 ADDED) ───────────────────────
//
// 열이 열넷이 된다. 갈랐던 규율을 그대로 잇는다 — 세계 위에 이름표가 없으므로
// (RULE-QUIET-GROUND-001) 그림이 유일한 구분이고, 이 넷도 **실루엣부터** 갈린다:
//   바닥에 넓게 깔리고 서릿발이 돋은 한 겹(가장 낮다) · 바위를 가르고 선 세로 날(가장 높다) ·
//   아무것도 이루지 않은 낱알(흩어졌다) · 언 사체 위에 가시처럼 돋은 결정(덩이 위에 선다)
//
// 앞의 열과는 색부터 갈린다 — 붉거나(C·c·G) 차갑게 옅거나(1·2) 청록으로 누운(V·Z) 것뿐이었고
// **채도가 선 파랑**(3·4·5)은 여기가 처음이다. 협곡의 바닥이 옅은 파랑(0xbcd0ec)이므로
// 그 위에 서려면 더 진하고 더 푸르러야 한다.
//
// 세 state 의 규율도 그대로다. available 이 가장 온전하고, depleted 는 "있던 것이 없어졌다"
// (한 겹이 벗겨지고 · 날이 떨어져 나가고 · 낱알이 거둬지고 · 가시가 부러진다), recovering 은
// "없던 것이 다시 오는 중이다" 이며 자국(맨 바닥 · 빈 틈 · 눌린 점 · 언 사체)은 **그대로 남은**
// 채 그 위에 새것이 얇게 얹힌다. 색의 양도 available > recovering > depleted 로 간다 —
// 빛나는 결정면(3)은 available 에만 서고, recovering 은 빛을 잃은 값(4·2)만 돌아오며,
// depleted 에는 깨진 밑동(5) 몇 점뿐이다.
//
// **얼마나 남았는지도 언제 다시 오는지도 말하지 않는다** — 앞의 열과 같은 약속이다.

// 밟아도 녹지 않는 푸른 서리 — 절벽 앞 바닥에 넓게 깔린 한 겹이고 그 위로 서릿발이
// 들쭉날쭉 돋았다. 넷 가운데 **가장 낮고 가장 넓다** (세로로 선 결정면과 정반대의 실루엣)
const SOURCE_RIME = [
  '................',
  '................',
  '................',
...
// 밟혀 걷힌 자리 — 한 겹이 벗겨지고 눌린 맨 바닥(d·D·e)만 낮게 드러났으며 깨진 밑동(5)
// 몇 점이 그 밖에 흩어져 있다. 넓게 덮여 있던 것이 맨살이 되는 것이 available 과 갈리는 자리다
const SOURCE_RIME_DEPLETED = [
  '................',
  '................',
  '................',
  '................',
...
// 다시 앉는 중이다 — 맨 바닥(depleted 의 그것 그대로)은 자국으로 남고 그 위에 얇은 결이
// 군데군데 얹혔다. 서릿발은 아직 하나도 돋지 않았고 빛나는 결정면(3)도 없다
const SOURCE_RIME_RECOVERING = [
  '................',
  '................',
  '................',
  '................',
...
// 절벽을 가르고 나온 푸른 결정면 — 바위가 좌우로 열리고 그 틈에서 날이 서서 솟았다.
// 서리(낮고 넓다)와 정반대로 **세로로 서고 각졌으며**, 양쪽의 바위 기둥이 그 세로를 좁게 묶는다
const SOURCE_FROST_VEIN = [
  'Rrrd...3....drrR',
  'rRrd..343...drRr',
  'Rrrd..343.3.drrR',
  'rRrd.34343.3drRr',
...
// 날이 떨어져 나갔다 — 바위(자국)는 그대로인데 갈라졌던 자리가 빈 틈(q·e)으로 남았고
// 밑동(5) 둘만 바닥에 박혀 있다. 서 있던 것이 사라지고 **구멍만 남는** 것이 갈리는 자리다
const SOURCE_FROST_VEIN_DEPLETED = [
  'Rrrd..eqqe..drrR',
  'rRrd..eqqe..drRr',
  'Rrrd.eqqqqe.drrR',
  'rRrd.eqqqqe.drRr',
...
// 틈에서 다시 올라온다 — 빈 틈은 그대로이고 그 아랫몫만 무딘 결정으로 찼다. 위쪽 절반은
// 여전히 비어 있다 — 다 온 것이 아니라는 것이 높이 하나로 먼저 읽힌다
const SOURCE_FROST_VEIN_RECOVERING = [
  'Rrrd..eqqe..drrR',
  'rRrd..eqqe..drRr',
  'Rrrd.eqqqqe.drrR',
  'rRrd.eqqqqe.drRr',
...
// 눈에 섞여 반짝이는 푸른 가루 — 덩이가 없다. 한두 점씩 낱알로 칸 전체에 흩어져 있고
// 눈(1) 몇 점이 그 사이에 섞였다. 넷 가운데 **유일하게 이어지지 않은** 실루엣이다
const SOURCE_DRIFT_DUST = [
  '................',
  '.....3....1.....',
  '...34......34...',
  '..4........4....',
...
// 거둬 간 자리 — 반짝이던 것이 한 낱도 없고 눌린 자국(e·d) 몇과 깨진 밑동(5) 둘만 남는다
const SOURCE_DRIFT_DUST_DEPLETED = [
  '................',
  '................',
  '....e...........',
  '................',
...
// 다시 섞이는 중이다 — 눌린 자국은 그대로이고 그 곁에 무딘 알갱이(4·2)가 몇 돌아왔다.
// 빛나는 점(3)도 눈(1)도 아직 없다 — 섞이는 중일 뿐 반짝이지는 않는다
const SOURCE_DRIFT_DUST_RECOVERING = [
  '................',
  '................',
  '....e...2.......',
  '........4.......',
...
// 언 사체에 돋은 푸른 결정 — 삭은 가죽 덩이(j)와 드러난 뼈(J)는 사체 위 흰 균사가 쓰는 그것과
// 같되, 그 위를 덮는 것이 그물(w·z)이 아니라 **가시처럼 돋은 날**이다. 바닥도 바위도 아닌
// **덩이 위**에 서는 셋째 받침이 이 그림을 앞의 셋과 가른다
const SOURCE_CORPSE_RIME = [
  '................',
  '.......3........',
  '...3...34.......',
  '...34..343...3..',
...
// 결정이 부러져 나갔다 — 언 사체는 그대로 남고 돋았던 자리에 밑동(5) 셋만 남았다.
// 덩이 위가 비는 것이 available 과 갈리는 자리다 — 낮아지되 사체는 그 자리에 그대로 있다
const SOURCE_CORPSE_RIME_DEPLETED = [
  '................',
  '................',
  '................',
  '................',
...
// 다시 돋는 중이다 — 사체(depleted 의 그것 그대로)는 자국으로 남고 부러진 밑동 위로
// 마디 하나짜리 것이 짧게 솟았다. 가시도, 빛나는 결정면도 아직 아니다
const SOURCE_CORPSE_RIME_RECOVERING = [
  '................',
  '................',
  '................',
  '................',
...
const PIXEL_MAPS: Record<string, string[]> = {
  ...
  // 지나간 것이 남긴 것 둘 (C018) — 표에 여섯 줄이 늘 뿐이다. 여덟이 열이 되어도 어법은 그대로다
  'source:fallen-scale:available': SOURCE_FALLEN_SCALE,
  'source:fallen-scale:depleted': SOURCE_FALLEN_SCALE_DEPLETED,
  'source:fallen-scale:recovering': SOURCE_FALLEN_SCALE_RECOVERING,
  'source:prey-remains:available': SOURCE_PREY_REMAINS,
  'source:prey-remains:depleted': SOURCE_PREY_REMAINS_DEPLETED,
  'source:prey-remains:recovering': SOURCE_PREY_REMAINS_RECOVERING,
  ...
  // 추위가 만든 것 넷 (C020) — 표에 열두 줄이 늘 뿐이다. 열이 열넷이 되어도 어법은 그대로다
  'source:rime:available': SOURCE_RIME,
  'source:rime:depleted': SOURCE_RIME_DEPLETED,
  'source:rime:recovering': SOURCE_RIME_RECOVERING,
  'source:frost-vein:available': SOURCE_FROST_VEIN,
  'source:frost-vein:depleted': SOURCE_FROST_VEIN_DEPLETED,
  'source:frost-vein:recovering': SOURCE_FROST_VEIN_RECOVERING,
  'source:drift-dust:available': SOURCE_DRIFT_DUST,
  'source:drift-dust:depleted': SOURCE_DRIFT_DUST_DEPLETED,
  'source:drift-dust:recovering': SOURCE_DRIFT_DUST_RECOVERING,
