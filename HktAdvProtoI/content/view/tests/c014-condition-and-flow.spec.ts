...
function made(options: Made): GameViewSnapshot {
  return {
    ...
    region: { id: options.region, hash: hashOf(options.region), disturbance: { value: 0, threshold: 300, phase: 'dormant' as const }, memory: { turns: 0, awakenings: { times: 0 }, passages: [] } },
    standingConditions: [],
