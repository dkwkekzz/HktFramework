...
function mazeSnapshot(state?: RegionStateView, hash?: string): GameViewSnapshot {
  return {
    ...
    scene: MAZE,
    region: { id: MAZE, hash: hash ?? hashOf(MAZE), disturbance: { value: 0, threshold: 300, phase: 'dormant' as const }, memory: { turns: 0, awakenings: { times: 0 }, passages: [], births: [] }, ...(state ? { state } : {}) },
    standingConditions: [],
