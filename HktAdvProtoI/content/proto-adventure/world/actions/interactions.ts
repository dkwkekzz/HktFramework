...
export const INTERACTIONS: readonly InteractionHandler<WorldState>[] = [
  ...
  {
    id: 'attack',
    handle: withActor((_state, actor) => ruleSkillBegin(actor, 'attack')), // 기본 스킬 — 대상을 받지 않는다 (C002)
  },
  {
    id: 'skill-heavy',
    handle: withActor((_state, actor) => ruleSkillBegin(actor, 'heavy-attack')), // 고급 스킬 (C007)
  },
  {
    id: 'move-mode',
