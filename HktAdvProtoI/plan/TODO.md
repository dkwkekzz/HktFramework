...
5  판정  방은 기억하고 때가 되면 내민다 실주행 — Offer-1 ~ Offer-6 (**새것** — 세계 규칙 하나가 늘었다)                              CYCLES.md §3.4
6  결정  값 · 규칙 — 판정 때 함께 보는 것이 싸다 (C034 가 남긴 넷은 Offer-5 · Offer-6 이 물었다)                                    CYCLES.md §3.2 각 절의 "결정 대기" · §3.3 · §3.4
...
10 주입  3층 나머지 절반 — 몸의 값 전반 · 생물의 앎과 선택 (후보 2 판정 뒤)                                                       DESIGN.md §1 · §5 후보 5
...
```text
1  Cycle      (Foundation 묶음이 닫혔다 — 판정 대기) 다음은 §2-2 묶음 제안 · Human 지목을 기다린다                              CYCLES.md §1 · §3.4
