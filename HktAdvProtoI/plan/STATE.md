...
|---|---|---|---|---|---|
| Human — 지목 · 승인 · 판정 · 주입 | Human | L0 · L1 · L2 아홉 · M1~M8 · L7 주입 · C001~C031 기획서 여섯의 판정 반영 · Foundation 지목 · Foundation Cycle 목록 승인 (Q1~Q9 제안대로 · 기반 집중) | **판정 셋** — 협곡 · 생명 · 요구와 가능성 (컨텐츠 행 — 실주행) · **지목** — 다음 기획서(후보 2 L3-Subject-Body · 3) | 판정 답의 반영 | HundredRooms 미지 백 줄의 이름 · 4~7층은 층이 열릴 때 |
...
순서 — 트랙 사이의 의존 (왼쪽이 먼저 · 병행은 나란히)
  ...
  기획서 순서     (1 Foundation — 닫힘) → 2 주체와 몸(3층 — L3-Subject-Body · Cycle A~D) ∥ 3 Rooms GAP 회수  →  4 HundredRooms  →  6 · 7 · 8 · 9 (4 · 5 · 6 · 7층)
  층의 순서       2층 닫힘(판정 셋 + 후보 3) → 3층(후보 2) → 4층 → 5층 → 6층 → 7층 — **이 차례대로 간다**(확정). 앞당길 일이 생기면 그때 Human 이 뒤집는다.
```

한 Cycle = 브랜치 `cycle/C###` = 세션 하나. **말할 것: "<기획서> 로 spec 써"**(다음 spec 제안 — 후보 2 L3-Subject-Body · 3 · 3.5) · 판정 넷의 답.
...
| (다음) 후보 2 L3-Subject-Body · 3 | C039~ | **제안 전** — "L3-Subject-Body 로 spec 써" |
