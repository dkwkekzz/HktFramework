...
| Cycle — 묶음 제안 → spec → 실현 → 마감 | AI (advprotoi-cycle) | C001~C034 (묶음 아홉 + Foundation 의 첫 Cycle — 옛 공정) · Foundation 묶음 승인 · C035 · C036 (닫힘 — 합침 대기) | **C037** — 때가 있는 기회 (초안을 「다음 Cycle 로」 로 손봐 동결 → 실현 · 묶음의 마지막) | AI 예심 | 다음 묶음 (C038~) |
...
순서 — 트랙 사이의 의존 (왼쪽이 먼저 · 병행은 나란히)
  ...
  (지금) Foundation 묶음 — C034 · C035 · C036 닫힘 ──→ C037(다음) ──→ AI 예심 ──→ Human 실주행 판정 ──→ 2층 Foundation 닫힘
...
한 Cycle = 브랜치 `cycle/C###` = 세션 하나. **말할 것: "<기획서> 로 묶음 잘라"**(다음 묶음 제안 — 후보 2 · 3) · 판정 셋의 답. C037 은 게이트 없이 앞 Cycle 의 마감을 받아 이어진다.
...
| 2 세계 자체 | **다음** | 기획 아홉 문서 중 여덟이 C001~C031 로 코드에 있다. Foundation 은 C036(방이 내미는 것)까지 — Event 가 C037 로 남았다. 판정 셋 · Rooms GAP 둘(후보 3) · 도구 묶음 하나가 남았다 |
...
| 방은 기억하고 때가 되면 내민다 (Foundation) | C034~C037 | **진행** — C034 · C035 · C036 닫힘 · C037 다음 (초안) |
...
| 레인 | 지금 | 기다리는 것 |
|---|---|---|
| Foundation | C037 (C036 닫힘 — 합침 대기) | C036 의 합침 |
