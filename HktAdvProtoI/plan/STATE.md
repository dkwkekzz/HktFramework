...
| Cycle — 묶음 제안 → spec → 실현 → 마감 | AI (advprotoi-cycle) | C001~C037 (묶음 열 · Foundation 넷 포함) · AI 예심(Offer-1~6) | **다음 묶음 제안** — Human 이 기획서를 지목하면 (후보 2 · 3) | C038~ | 그 묶음의 예심 → 판정 |
...
순서 — 트랙 사이의 의존 (왼쪽이 먼저 · 병행은 나란히)
  ...
  (지금) Foundation 묶음 — C034~C037 닫힘 ──→ AI 예심 끝(기반 검토 실측) ──→ **Human 결정(값 · 규칙)** ──→ 2층 Foundation 닫힘
...
| 방은 기억하고 때가 되면 내민다 (Foundation) | C034~C037 | **결정 대기** — 기반 검토 끝(실측) · 값 셋 · 규칙 다섯 |
