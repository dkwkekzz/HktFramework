...
| ENGINE — 게임 명사 없는 기구 | AI | Region 작성기 T1~T6 · T3 이 생명·철·물음을 낸다 · T2 의 열세 질문이 다 섰다 | **T5 초안기 실주행** · T6 대량 후보 | HundredRooms 묶음의 전제 | 큰 Region 이 올 때 chunk 적재 |
...
순서 — 트랙 사이의 의존 (왼쪽이 먼저 · 병행은 나란히)
  ...
  ENGINE T3 · T2 확장 (생명·철·물음 · 열세 질문 — 닫힘) ──→ T5 실주행 · T6 대량 ──→ HundredRooms 묶음(Human 이름) ──→ "C### 진행" ──→ Cycle (코드 diff 0)
