...
쓰는 이  advprotoi-inject — 주입 보존 때 §1/§2 의 행 · §3 의 절 · 질문. advprotoi-cycle — 묶음 승인("C### 진행") · 실주행 판정 반영 때. advprotoi-spec 은 읽기만(§1 열린 층 · §3 남은 것 · §5 후보). Cycle 마감이 "뒤 층 · 뒤 묶음으로" 보낸 것은 §3 의 "남은 것" 에 바로 적는다.
