...
(function (root, factory) {
  ...
  //   opts: { scale(0.08), nTemp(3), nHum(3), tempSalt('T'), humSalt('H'), elevSalt('E'), lapse(0), latAmp(0), latPeriod(256), …fbm }
  ...
  return { fnv1a, hashIndex, valueNoise2D, fbm, fieldNoise, biomeField, streamChunks, VERSION: 5 };
});
