...
| 폴더 | 분류 | 내용 |
|---|---|---|
| [state/](state/) | **작업 상태** | `CURRENT-CYCLE.md`(현재 Cycle + Stage 진행) · `WORLD-BASELINE.md`(검증된 세계 의미) · `EVOLUTION-BACKLOG.md`(유예 Semantic) · `cycles/`(Cycle별 Artifact 기록) |
...
| [design/](design/) | **기획 문서** | 세계 개념 · 워크플로 원문 · Target Horizon — fallback reference, 필요할 때만 읽는다 |
