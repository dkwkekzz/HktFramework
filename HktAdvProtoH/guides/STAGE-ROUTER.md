...
| 요청 유형 | Stage | Guide | 입력 Artifact (cycles/cycle-XXX/) | 출력 Artifact |
|---|---|---|---|---|
...
| Baseline 병합 | World Baseline Merge | [STAGE-7-BASELINE-MERGE.md](STAGE-7-BASELINE-MERGE.md) | `05` + `06` (모두 통과) | `context/WORLD-BASELINE.md` 갱신 |
...
+
context/CURRENT-CYCLE.md  (Current Cycle Contract)
+
...
2. `context/CURRENT-CYCLE.md`의 Stage 진행 상황 표를 갱신한다.
3. `STATE.md`에 한 줄 진행 기록을 남긴다.
4. **STOP** — 다음 Stage를 실행하지 않는다.
