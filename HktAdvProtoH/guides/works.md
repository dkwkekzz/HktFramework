...
| **VIEW** | 관찰만을 위한 화면 작업 — 이미 관찰에 실린 것을 더 잘 보이게 한다. 세계·관찰 계약 불변 | `view/` · `works/` | **할일: `works/BACKLOG.md`** (슬러그 = 작업 키 · 완료 기록은 커밋 · UX 기획서 주입 = 번역) | `advprotoh-view` · guides/view-work.md |
...
```text
VIEW 가 발견한 세계 관찰의 결손   → works/BACKLOG.md 의 관찰 결손 REPORT 절 → Human → (진짜면) Frontier 후보
