...
- `cycles/cycle-XXX/02-world-definition.md` (**APPROVED 필수** — `03-semantic-review.md`로 확인)
- Repository
- 이 Stage Guide
...
- 코드 (Repository)
- `cycles/cycle-XXX/04-implementation-result.md` — [../templates/IMPLEMENTATION-RESULT.md](../templates/IMPLEMENTATION-RESULT.md) 형식
