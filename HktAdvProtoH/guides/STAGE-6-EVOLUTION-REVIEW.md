...
- `cycles/cycle-XXX/00-cycle-contract.md` (Evolution Questions)
- `cycles/cycle-XXX/02-world-definition.md`
- `cycles/cycle-XXX/05-verification-report.md`
- `context/TARGET-HORIZON.md`

## 출력

- `cycles/cycle-XXX/06-evolution-review.md` — [../templates/EVOLUTION-COMPATIBILITY-RESULT.md](../templates/EVOLUTION-COMPATIBILITY-RESULT.md) 형식
- 필요 시 `context/EVOLUTION-BACKLOG.md` 항목 추가
