...
- `cycles/cycle-XXX/04-implementation-result.md`
- 코드 (Repository)

## 출력

- `cycles/cycle-XXX/05-verification-report.md` — [../templates/VERIFICATION-REPORT.md](../templates/VERIFICATION-REPORT.md) 형식
