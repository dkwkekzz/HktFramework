...
- `cycles/cycle-XXX/01-intent-package.md` (대조용)

## 출력

- `cycles/cycle-XXX/03-semantic-review.md` — [../templates/SEMANTIC-REVIEW-RESULT.md](../templates/SEMANTIC-REVIEW-RESULT.md) 형식
