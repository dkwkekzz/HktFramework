...
export const MOTION_ATLAS: MotionAtlas = {
  ...
  "/motions/rabbit-swordsman/move.3x3.9f.8fps.png": {
    ...
    refHeightPx: 385,
    frames: [
      { rect: [11, 10, 381, 393], content: [30, 10, 323, 385], anchor: [0.51064, 0] },
      { rect: [392, 10, 422, 393], content: [442, 10, 336, 383], anchor: [0.50961, 0] },
      { rect: [814, 10, 392, 393], content: [861, 10, 341, 385], anchor: [0.51035, 0] },
      { rect: [11, 403, 381, 398], content: [11, 412, 339, 378], anchor: [0.51064, 0] },
      { rect: [392, 403, 422, 398], content: [445, 414, 327, 376], anchor: [0.50961, 0] },
      { rect: [814, 403, 392, 398], content: [851, 415, 350, 368], anchor: [0.51035, 0] },
      { rect: [11, 801, 381, 393], content: [16, 812, 332, 377], anchor: [0.51064, 0] },
      { rect: [392, 801, 422, 393], content: [432, 816, 346, 363], anchor: [0.50961, 0] },
      { rect: [814, 801, 392, 393], content: [884, 813, 322, 381], anchor: [0.51035, 0] },
    ],
    warnings: [],
  },
