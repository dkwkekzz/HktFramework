...
// C025 CHANGED — 그 호의 각·반경·길이는 **그 기술의 값**이다. 전역 상수가 아니다.
...
// C025 CHANGED — 휘두름의 각·칼끝 반경·닿는 길이는 더 이상 여기 있는 전역 상수가 아니다.
...
export function actionCollider(actor: ActorState): ActionCollider | null {
  ...
  // C025 CHANGED — 모양도 그 기술에서 읽는다 (RULE-SKILL-SHAPE-001).
