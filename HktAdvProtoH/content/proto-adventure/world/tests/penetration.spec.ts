...
import { effectiveDefense, penetrationRemainingRatio, SKILL_DEFINITIONS } from '../domains/combat/combat';
import { TICK_INTERVAL } from '../base/world-state';
import { ruleDamageCalculate } from '../domains/combat/damage-calculate';
