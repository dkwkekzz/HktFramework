...
4. 땅이 무엇을 할지 미리 말해 주지 않는다  (C-TERRAIN-002 로 **땅이 돌기 시작했다**)
   ...
   **남은 것은 그것을 미리 읽는 일이다.** 지금 세계는 안전한 자리가 옮겨 다니는데
   ...
   (Design-Resource-Catalog-R0)는 **주입되었고 이음매도 닫혔다** (HISTORY Q73~Q75 —
   좌표는 원본 문서의 것 · 이름 정본은 BT · 회복 조합은 한 노드). **BT 자원
   24종까지 growth/items 에 섰다** — 지형마다 셋, 전부 대지형 좌표다. 남은 것은
   세계 구현이다: Master 에 유래가 선 것이 세계에 자원이 선 것은 아니다 —
   MW-TERRAIN-RESOURCE 는 여전히 ABSENT 다.
