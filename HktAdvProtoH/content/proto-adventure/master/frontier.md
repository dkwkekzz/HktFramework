...
| 4 | **행동 중단** | 진행 중인 행동을 끊어 없던 일로 만든다 | 노려서 끊는 수단 | 작다 |
...
### 4. FR-INTERRUPT-DENIES-THE-BLOW — 행동 중단
    ...
    후보 3 과의 관계    서로를 요구하지 않는다. 다만 3 이 먼저 서면 "무엇이 오는지 알고
...
5. 행동 중단        가장 작은 전투 후보 — 끊김 규칙이 이미 있어 조건 하나만 붙이면 되고
                    DANGER 층 요구도 미리 채운다
```
