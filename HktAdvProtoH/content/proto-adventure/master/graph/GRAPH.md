...
Capability 구현 상태 — ■ IMPLEMENTED 8 · ▨ PARTIAL 9 · □ MISSING 28
...
| `BET-ON-THE-CRITICAL-BLOW` | OVERCOME-SUPERIOR-OPPONENT | ●●●○○ 1/3 | CRITICAL-STRIKE · ATTACK-POWER |
...
flowchart LR
  ...
  class MC-CRITICAL-STRIKE,MC-PERFECT-GUARD,MC-COUNTER,MC-COMBAT-FLOW,MC-FORTIFY,MC-EVADE,MC-VOW,MC-PREDICT,MC-CONTROL-SPACE,MC-READ-ENVIRONMENT,MC-USE-HAZARD,MC-RESTORE-BIOLOGICAL-STATE,MC-CUT-ABNORMAL-STRUCTURE,MC-DESIGNATE-TARGET,MC-RELATION-STANCE miss;
