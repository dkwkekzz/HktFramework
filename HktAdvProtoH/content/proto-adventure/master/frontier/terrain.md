...
## 추천 순서
    ...
    3. FR-LOSING-IS-A-PROCESS               **Q71(b) 확장으로 새로 열렸다.** 넷 중
                                            유일하게 **다른 Goal** 을 연다 —
                                            MG-RESCUE-THE-TAKEN 은 갈래 셋을 가졌으나
                                            셋 다 "되돌릴 자리가 남아 있다" 를 전제하고,
                                            그 전제가 이 후보다. 의존이 없다
    4. FR-THE-LAND-IS-ALIVE-AND-ANSWERS     같은 확장에서 열렸다. **읽을 것은 이제 있다** —
    ...
    **다만 3 은 다른 축이다.** 1·2·4 가 전부 "땅이 무엇을 하는가" 라면 3 은 "존재가
