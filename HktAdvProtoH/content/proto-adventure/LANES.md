...
| ENGINE | OPEN | 기반 부채 하나 — 표시 문구를 사유 코드로 바꿔 팩에 회수 (C009 폭이 넓고 조립·팩 채택 동반 — 착수 전 범위 확인). 영속(저장·복구)은 설계 승인 대기 — 아래 HUMAN 대기 | 없음 |
...
| Design-World-Persistence.md 승인 (루트 design/) | ENGINE 영속(스냅샷·복구) 구현 착수 |
