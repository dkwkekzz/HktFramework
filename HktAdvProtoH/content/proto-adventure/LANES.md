...
| MASTER | OPEN | OPTIONS Q35 (몸이 아닌 존재를 요구하는 Possibility) — 세계 무대(BT) 주입은 끝났다 | 없음 — 미처리 Feedback 이 0 이라 막던 것이 사라졌다 (`npm run feedback:gate`) |
...
| Design-Resource-Catalog-R0.md 승인 | Inject → Q36 · 회복 아이템 해금 · BT 자원 24종의 자리 (Q50) |
| 대지형 Constraint 넷 승인 (open-questions Q51) | 그 넷을 노드에 배선 — 지금은 걸린 노드가 0 이다 |
| Q47 · Q48 — 대지형과 깊이 층 · 갈비분지와 문명권 (open-questions.md) | 땅이 세계에 들어오는 첫 Cycle 의 모양 |
