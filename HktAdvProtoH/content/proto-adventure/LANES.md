...
| **Q72 — 전투 지식의 정의가 앎(MK-*)의 자리에 있다** (open-questions.md) | 전투법의 정의가 어디 사는지가 정해진다. 막는 것은 없으나 KNOWLEDGE Cycle 의 03 이 저장 형태를 정할 때 걸린다. **바로 착수 가능** — 질문에 만질 파일 넷과 건드리지 말 것(능력 일곱)이 적혀 있다. Agent 추천 (a) |
