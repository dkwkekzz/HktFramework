...
| WORLD·TERRAIN | HUMAN | `C-TERRAIN-003` Stage 1~4 섰다 — SELECTED `FR-THE-LAND-SHOWS-BEFORE-IT-TAKES` · Target `MW-CIRCULATION-EVIDENCE`. **Stage 5 Human Semantic Review 대기** — 물어 둔 것 셋: 급습을 함께 세우는가 · 맞고 버티는 것이 이득일 수 있어도 되는가 · 자국이 자리 전체인가 한 점인가 | Human Semantic Review (05-review.md) |
