...
describe('그림의 기준 방향 (C008 spriteOrientation)', () => {
...
describe('좌우가 흐려지는 구간 (C008 ambiguous: keep-previous)', () => {
...
describe('결정 Layer 통합 — 시점을 돌리면 그림이 뒤집힌다 (C008)', () => {
  ...
  it('보이는 쪽과 칼끝이 지나는 쪽이 어긋나지 않는다 — 어느 시점에서도 (C008 핵심)', () => {
