...
describe('문구 반전 ⑤ — 기반 키의 이름도 팩이 준다', () => {
...
describe('V-005 — 팩의 키가 안내 패널에 선다', () => {
  it('기반 넷 아래에 한 번도 뜬 적 없던 여섯이 선다', () => {
    expect(panelKeyHints()).toEqual([
      // 기반이 소유하던 넷 — 이제 keyHints 를 타고 온다 (문구 반전 ⑤)
      '명령: /',
      '이동: WASD / 방향키',
      '충돌체 관찰: C',
      '속성 관찰: V',
      ...
      '바꿔 걸기: ,',
      '가진 것: I',
      // C-COMBAT-001 — 힘의 배분. 앞의 넷과 같은 두 걸음이다
      '배분: U',
      // V-018 — 방금 있었던 일 (되짚는 자리). 글자 자리가 아니다 — 합류에서 옮겼다
      '방금 있었던 일: `',
    ]);
  });
