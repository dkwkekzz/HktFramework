...
S0 이 닫혔다. 대표 장면은 "배고픈 인간 1 + 음식 1 (아직 행동 없음)" 이고, 남은 것은 S1~S3 · D0~D4 다.
...
**단계 1 (M1 의존하는 주체) 진행 중** — S0 이 VERIFIED 로 닫혔고 레지스트리가 위상 순서
`V1 → V2 → V0 → V4 → V3 → O1 → O2 → O0 → S0` 으로 등록한다. 남은 것은 S1~S3 · D0~D4.
