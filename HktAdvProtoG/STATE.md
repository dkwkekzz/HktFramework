...
| [design/Design-ModulePlan-CycleWorkflow.md](design/Design-ModulePlan-CycleWorkflow.md) — MMORPG Cycle 기반 2차원 점진 구현 WORKFLOW (최상위 구현 기준) | 작성 완료 |
...
- [ ] **Foundation (Phase 0)** — V0~V4 검증 기반 + Cycle/Situation/Scenario/Step 스키마 + 리플레이 저장소 +
      ...
      (design/Design-ModulePlan-CycleWorkflow.md §9 Phase 0).
