...
- **닫힌 step**: [step-0318](step-0318.md) — **#9 잔여: host 부하 균형 술어 `hostBalanced` (부하 sub-arc 0311~0317 capstone)**. 존 수·entity 불균형 둘 다 허용 안. entity 몰린 클러스터 hostBalanced 전 false→placeRebalanceE→true·균형 후에도 conserved·coherent. 읽기 전용·0317 비트 동일.
- **한 줄 상태**: reg ALL OK·hostbalancecap 5/5(bal0 false→bal1 true·skew 4→0·consv·hcoh)·`run.js all` ALL OK·spine ALL OK.
