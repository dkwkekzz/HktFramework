...
- **닫힌 step**: [step-0328](step-0328.md) — **#9 후속: 다운스트림 세션 무굶김 (모두 keyframe 수신)**. 술어 zoneViewAllKeyed(모든 활성 세션이 초기 reset keyframe 받음). a1·a2·a3 enter→세 세션 모두 keyed·아무도 안 굶음. 읽기 전용·0327 비트 동일.
- **한 줄 상태**: reg ALL OK·hostzonekeyed 5/5(sessions3·allKeyed·resets1/1/1)·`run.js all` ALL OK·spine ALL OK.
