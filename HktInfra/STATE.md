...
- **닫힌 step**: [step-0329](step-0329.md) — **#9 후속: 다운스트림 뷰 무손실 회계 (고아 frame 0)**. 술어 zoneViewConserved(모든 view frame 이 정확히 한 세션 귀속·세션별 합==전체). a1·a2·a3 enter+이동→frames 8==sumSess·고아 0. 읽기 전용·0328 비트 동일.
- **한 줄 상태**: reg ALL OK·hostzoneconsv 5/5(frames8==sumSess·consv)·`run.js all` ALL OK·spine ALL OK.
