...
| 3 | 게임 서비스 | 가방 · 채팅 · 길드 · 거래소 · 우편 · 랭킹 | 🟡 가방/채팅/ranking/읽기모델(0014~0022)→write-behind/quorum(0023~0032)→대체 소비자(0061~0063). **귓속말/파티 라우팅 wrouter(0071~0106)**: 라우팅·failover·1:N·멤버십·전달 신뢰·파티 집계/영속·epoch 펜싱·수신함 유계/드레인. **거래소 arc 0107~0140**: escrow 쌍 거래·발행 7종·영속/압축·시세 피드·만료 TTL·가방 give 3leg·2-서비스 보존·saga liveness(0121~0140: 자율 복구·네 정합층 완성·전문 §7). 정리 0124/0133. **우편 arc 0142~0164**: 메시지(0142~0150 입금/수령/발행 3종/영속·압축/만료 TTL/회계 capstone)·미읽음 배지 읽기 모델 MailFeed(0151~0156)·아이템 첨부(0157~0160 첨부/수령/만료/itemConsistent)·**가방 연동 3 레그+2-서비스 보존(0161~0164** 발신 인출 leg1·수령 입금 leg2·만료 반환 leg3·escrowItemIds 교차 정합·거래소↔가방 0117~0120 의 우편 판**)**. 신성한 tick·권위 0. 아이템 우편 saga·발행 게이트·길드 후속 |
