...
- **닫힌 step**: [step-0173](step-0173.md) — **아이템 우편 saga 재시도 상한**(mailMaxRetries·거래소 0131 의 우편 판): _resendPending 에 gid 당 재전송 상한. 도달 시 포기(pendingGive 제거·giveAbandoned++)·pending(Set) 잔존(sagaConsistent 불변). maxRetries 0=무제한=0172 비트 동일. 닿는 박스: svc-mail-core/txn/persist·topo-build.
- **한 줄 상태**: reg ALL OK·mailmax: 지속손실 무제한 4/0·상한2 2/1 포기·양체제 pending 1·sagaConsistent·spine OK.
- **다음**: §2 — saga 포기 발행(mailAbandonPublish·거래소 0132)·발행 게이트 통합·길드 서비스·비동기 결정론🔴·**0161~0170 묶음 리뷰(`infra-review`) 적기**.

---

## 2. NEXT — 가설 (후보, 권위는 이 절)

**우편(Mail) 박스 = 거래소 arc(0107~0140)와 동형 골격 완성: 메시지(0142~0150)·미읽음 배지(0151~0156)·아이템 첨부(0157~0160)·가방 연동 3 레그+2-서비스 보존(0161~0164)·saga(0166~0173 회신/추적/재전송/정합/transfers/autoRetry/재시도상한 — 거래소 0121~0140 의 우편 판)✅. 다음 arc 후보: *포기 발행*(mailAbandonPublish·거래소 0132)·*재admission*(거래소 0134~0138)·*발행 게이트 통합*·*길드 서비스*·*비동기 결정론*(🔴). 🔧 svc-mail-core 30.7KB(0171 유계). 🔎 0161~0170 묶음 리뷰 적기.**
...
| 🟡 | **거래소 ✅(0107~0140)·우편 ✅(0142~0173)·랭킹/읽기모델 ✅·길드 ⬜** | 서비스 | 거래소(escrow·발행 7종·saga liveness)·우편(메시지·배지·아이템·가방 3레그+saga 0161~0173). 길드·발행 게이트 후속. |
...
> **✅ 해소된 격차** — 전문은 §7 INDEX(1줄/step)·각 `step-NNNN.md`. 묶음: 골격~전송(01~04)·AOI~failover(05~13)·게임서비스+영속+quorum(14~32)·버스(33~63)·프레즌스/귓속말/파티(64~106)·거래소(107~140)·우편(142~173).
...
| 3 | 게임 서비스 | 가방 · 채팅 · 길드 · 거래소 · 우편 · 랭킹 | 🟡 가방/채팅/ranking/읽기모델+write-behind/quorum+대체소비자(0014~0063)·귓속말/파티 wrouter(0071~0106)·거래소 escrow/발행/영속/시세/가방 3leg/saga liveness(0107~0140·정리 0124/0133)·**우편(0142~0173)**: 메시지+배지+아이템+가방 3레그+saga(회신/추적/재전송/정합/transfers/autoRetry/재시도상한 — 거래소 0121~0140 의 우편 판·정리 0165/0171). 신성한 tick·권위 0. 포기 발행·길드 후속 |
