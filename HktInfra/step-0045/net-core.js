// HktInfra step-0045 — 요청 replay 버퍼 *자기-크기조정* (ack 기반 가지치기·busAck — 고정 K 수동 튜닝 해소).
...
//   ack 무손실(minted==base·desync 0)·버퍼 peak 가 가동 길이 무관(무계는 ∝발신 수)·idle drain. 동결 단위는 step-0045/ 디렉토리 통째.
'use strict';
