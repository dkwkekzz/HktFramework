// HktInfra step-0045 — 소비자 lease/축출 (영구 뒤처진 소비자를 min 정의역에서 떨궈 outBuffer 무계 보유 해소·busConsumerLease).
...
//   lease ON 이면 죽은 소비자 축출 후 outBuffer peak 가 run-length 무관(유계)·산 소비자 오축출 0·원장 권위 무영향. 동결 단위는 step-0045/ 디렉토리 통째.
'use strict';
