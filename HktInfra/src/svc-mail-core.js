...
const { fnv1a } = __c;
// step-0268 분할 — saga 헬퍼 믹스인(_custody·_resendPending·_readmit).
const { MailSaga } = (typeof module !== 'undefined' && module.exports && typeof require !== 'undefined')
  ? require('./svc-mail-saga.js') : globalThis.__HktNetParts.svc_mail_saga;
...
// step-0268 분할 — saga 헬퍼를 프로토타입에 되섞음(정의 위치만 이동·this 바인딩 동일·reg 0). _custody 는 txn(onMsg)이 호출.
Object.assign(MailService.prototype, MailSaga);
