'use strict';
// step-0053 정리 분할 — InventoryService 진입점. 원장 코어 + 트랜잭션 + write-behind 영속 + 버스 결과/replay 네 부품을 묶어
...
if (__isNode) { require('./svc-inventory-txn.js'); require('./svc-inventory-persist.js'); require('./svc-inventory-bus.js'); }
