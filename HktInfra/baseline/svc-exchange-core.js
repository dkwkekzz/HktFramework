...
// step-0264 분할 — 영속/스냅샷/failover 메서드 믹스인(_bump·_snapState·_restore·_journal·crash·reconstruct).
const { ExchangePersist } = (typeof module !== 'undefined' && module.exports && typeof require !== 'undefined')
  ? require('./svc-exchange-persist.js') : globalThis.__HktNetParts.svc_exchange_persist;
...
// step-0264 분할 — 영속/스냅샷/failover 메서드를 프로토타입에 되섞음(정의 위치만 이동·this 바인딩 동일·reg 0). 0124 txn 증강과 같은 패턴.
Object.assign(ExchangeService.prototype, ExchangePersist);
