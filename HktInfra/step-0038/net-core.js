// HktInfra step-0038 — 정리 step: topology.js 박스-부품 분할 (31KB>30KB 박스 트리거 — 기능 추가 0).
...
//   분할은 *내부 파일 구조*만 — 동결 단위는 여전히 step-0038/ 디렉토리 통째. headless·원격 검증: node run.js 가 이 진입점 하나를 require — 검증 경로 무변경.
'use strict';
