// HktInfra step-0043 — 헤드리스 검증 (가방 seenReqs dedup 집합 *유계화* — 게이트웨이 prune 워터마크·busSeenBound)
// 사용: node step-0043/verify.js <mode> [seed]
...
const NETPREV = require('../step-0042/net-core.js');   // reg 대조용(직전 step)
