// HktInfra step-0035 — 헤드리스 검증 (버스 *failover* — 구독 재협상으로 라우팅 복구)
// 사용: node step-0035/verify.js <mode> [seed]
...
const NETPREV = require('../step-0034/net-core.js');   // reg 대조용(직전 step)
