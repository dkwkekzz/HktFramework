// HktInfra step-0036 — broker(버스 허브). 멀티프로세스 lockstep 배리어를 *토픽 pub/sub 버스* 위에서 구동한다(Node 전용).
...
//
// [step-0036 분할] 이 파일은 *Cluster 클래스*(broker 버스 허브)만 담는다 — frameOf/Framer 는 cluster-wire.js, computePlacement/runMulti 는
