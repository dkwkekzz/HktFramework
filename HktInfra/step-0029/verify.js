// HktInfra step-0029 — 헤드리스 검증 (PersistStore quorum *쓰기* ack — W 정족수 확인 후 durable 선언·정합성 윈도 가시화)
// 사용: node step-0029/verify.js <mode> [seed]
...
const NET16 = require('../step-0028/net-core.js');   // reg 대조용(step-0028)
