// HktInfra step-0046 — 헤드리스 검증 (소비자 lease/축출 — 영구 뒤처진 소비자를 min 정의역에서 떨궈 outBuffer 무계 보유 해소·busConsumerLease)
// 사용: node step-0046/verify.js <mode> [seed]
...
const NETPREV = require('../step-0045/net-core.js');   // reg 대조용(직전 step)
