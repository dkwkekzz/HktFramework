...
> 현재 규모: `data/world-state.json` **vars 81 · rules 61 · actions 22 · objectives 8 · clocks 2** (상태의 유일 원본).
...
- **베이스라인**: 사건 5종 + 아르카론 보스전 권역 시드로 **99/335 분류(29.6%)** — 번역 54·서사 36·보류 9. 노드 완료 40·미착수 135. 미분류 236(백로그): G 104·E 44·R 34·L 17·T 13·K 9·F 9·S 2·H 3·X 1. (보스전 D 작업이 커버리지 91→99 로 반영됨 — 도구가 진척을 실측.)
