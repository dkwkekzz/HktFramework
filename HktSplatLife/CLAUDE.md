...
- 셰이더↔엔진 **바이트 일치**: `Splat` 48B=`SPLAT_STRIDE` 12 float · `Entity` 256B(64, R1 재질 +
  F1 이펙트 + F2 굴절 + F3 파열 + F4 광선 + F5 방위 포함) · `Cluster` 96B(24) · `CamParams` 256B(fog+조명) · 격자 상수(GD=64, SLOTS=16) ·
