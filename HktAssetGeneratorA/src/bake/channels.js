...
export function createSwordShader(uniformsByPart) {
  return function shade(frag) {
    ...
    // ── Height (→ Normal, 원본 §20) — 미세 표면 + 감기 골 ──
