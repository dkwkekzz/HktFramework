 ...
 * 피드백 루프를 구조적으로 제거한다. 새 방식이 필요할 때 IHktVoxelChunkLoader를
 * 구현하고 EHktVoxelLoaderType에 enum 값을 추가한 뒤 팩토리 switch만 갱신하면 된다.
 */
...
public:
	...
	virtual void Configure(const FHktVoxelLoaderConfig& Cfg) = 0;
