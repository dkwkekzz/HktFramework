...
private:
    ...
    void Op_DispatchEventByReg(FHktVMRuntime& Runtime, RegisterIndex TagNetIndexReg);
    ...
    void Op_GetVoxelTypeAtEventLocation(FHktVMRuntime& Runtime, RegisterIndex Dst);
