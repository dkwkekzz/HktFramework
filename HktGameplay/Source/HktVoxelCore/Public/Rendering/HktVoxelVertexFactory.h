 ...
 *
 * FHktVoxelVertex (16바이트)의 두 uint32 스트림과 int16×4 bevel-offset 스트림을
 * 읽어 셰이더에서 위치, 크기, 법선, 재질, AO, 베벨 오프셋을 언팩한다.
 *
...
public:
	struct FDataType
	{
		...
		FVertexStreamComponent BevelOffsetComponent; // BevelOffsetPacked (int16 × 4, .w = padding)
	};
