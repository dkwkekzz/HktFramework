...
const REFERENCE = {
  ...
  extras: [
    ...
    // 승모근 — 목밑에서 어깨로 흐르는 경사 (시트의 어깨 경사선). 정점 메시의 flood 차단이
    // 목 envelope 구의 어깨 몫을 걷어내면서 이 extra 가 f≈0.19 행 어깨선 폭의 주인이 됐다 —
    // b 끝을 어깨 능선(x 0.118, 어깨 관절 위)까지 연장해 승모근 능선이 실루엣을 직접 그린다.
    { joint: 'Spine2', mirrorX: true, a: [0.012, 0.118, 0.002], b: [0.118, 0.095, 0.0], ra: 0.028, rb: 0.036, k: 0.06, group: 'chest' },
