...
| WP-03 | Muscle Architecture 다양화 | ✅ ①②③ 완료 (MultiHead 이월) | Phase 1 |
...
**WP-03 ①②③(방추형 + 납작화 + Fan/Sheet) 완료** → 다음 후보:
- **WP-04 (Joint Function & 길항)** — 삼두근이 굴곡 시 길어지도록(모멘트암), 근육 크기를 요구
  토크로 초기화. 팔 데모의 길항쌍을 완성. 권장(팔 프로토타입 기능 완성).
- **WP-06 (Fat/Fascia & 체형)** — 마른/근육질/비만 프리셋. 피부가 처음으로 체형에 반응.
- **WP-02b(wrap)** — 깊은 굴곡 관통이 실제 측정되는 시점에.
- **WP-03 MultiHead** — 이두/삼두 두 갈래(우선순위 낮음).
