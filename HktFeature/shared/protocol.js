...
export const MSG = {
  ...
  TARGET: 'target',      // { kind:'crystal'|'creature'|'none', seq } — 클릭/터치로 **지정한 표적**(feature-0010 step4). 서버가 표적 종류로 욕구를 추론(결정=식사·더 작은 생명체=사냥)해 그 특정 표적으로 가서 상호작용. kind='none'=해제(대기→수동이동)
  ...
  CREATURE: 'creature',  // { cells: [[seq, x, y, z, balance, size, desire, owner, desires, items, cmd]] } — 생명체 스냅샷 (feature-0006 size=스탯, feature-0010 desire=승자 욕망·owner=제어자·cmd=지정 표적 [kindCode,seq] 또는 0(step4), feature-0012 desires=중첩 스택. 표시용·읽기전용)
