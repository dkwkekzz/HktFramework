// ============================================================================
// feature-0011 step2 — 다단계 제조: 재료 → 중간물 → 완성물 (절차 깊이 확장)
//
// 직관: feature-0010 step2 의 제조는 한 번(재료 둘 → 산물)으로 끝났다. 이 step 은 그 절차를 **다단계**로
...
//   이것이 feature-0011 의 "절차 깊이 확장"이다 — 엔진은 여전히 첫 적용 단계만 실행하되 단계가 깊어졌다.
