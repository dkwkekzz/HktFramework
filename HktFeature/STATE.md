...
- **완료**: 프로젝트 초기 설정. 엔진 기반(`shared`·`server`·`client`·`tools`) 이식.
- **검증 상태**: `npm test` **46/46** · 서버+봇 8기 라이브 세계 총 에너지 **1,000,000,000** 불변·체크섬 OK.
- **열린 feature**: 없음 (다음 feature 논의 대기). feature-0001 은 검증 상시 가능.
