...
### 격차 (메커니즘은 완비, 의도-수준 격차는 children 으로 위임)

본 의도의 **메커니즘** 은 완비됐다. 그러나 본 의도가 표현하려던 "풍부한 자연 + World 별 유연함" 이 *실제로* 성립하려면 메커니즘만으로는 부족하다는 점이 드러난다.

- 콘텐츠 결합이 silent 로 어긋날 수 있다 → [I-0015](I-0015.md) (왜: 디자이너 의도의 무결성)
- World 별 placement 의 *표현 비용* 이 World 수에 비례한다 → [I-0016](I-0016.md) (왜: 의도-수준 표현)
- 결정론을 유지하면 한 종류 entity 만 빽빽해진다 → [I-0017](I-0017.md) (왜: 결정론 안의 다양성)
- 자연을 이루는 entity 종이 부족하다 (Oak/Birch 만) → [I-0010](I-0010.md) (왜: 자연 콘텐츠 자체의 다양성)
...
I-0014 가 메커니즘을 세웠다면, 아래는 그 메커니즘이 본래 표현하려던 자연의 *풍부함·유연함·신뢰성* 이 실제로 성립하기 위한 의도들이다.

| ID | 의도 (왜) |
|---|---|
| [I-0010](I-0010.md) | 자연을 이루는 entity 가 다양해야 한다 (콘텐츠 차원) |
| [I-0015](I-0015.md) | 콘텐츠 디자이너의 placement 의도가 silent 로 손실되지 않아야 한다 |
| [I-0016](I-0016.md) | 디자이너의 표현 단위는 저수준 매핑이 아니라 "이 World 의 자연이 무엇인가" 여야 한다 |
| [I-0017](I-0017.md) | 결정론이 자연의 동질성을 강제해선 안 된다 |
