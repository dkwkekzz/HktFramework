...
static FHktTestResult Test_ParseAndBuild_SpawnerPattern()
{
	...
	FString Json = TEXT(R"({
		...
		"steps": [
			...
			{"op": "CountByTag", "dst": "R0", "tag": "Entity.NPC.3DActor.Goblin"},
			{"op": "LoadConst", "dst": "R1", "value": 5},
			{"op": "CmpGe", "dst": "Flag", "src1": "R0", "src2": "R1"},
			{"op": "JumpIf", "cond": "Flag", "label": "wait"},

			{"op": "SpawnEntity", "classTag": "Entity.NPC.3DActor.Goblin"},
			...
			{"op": "AddTag", "entity": "Spawned", "tag": "Entity.NPC.3DActor.Goblin"},
