/* HWS step-0046 헤드리스 검증 — 생명의 폐열(슈뢰딩거 음엔트로피: 생명이 질로 산다).
 ...
 *   회귀: kLifeHeat=0 → heat 0 → metabolized += cost = 직전 step(0045) 비트 동일(Eth 무변경·qualInit 미설정 → Eth 해시 skip).
 *
 * 사용: node step-0046/verify.js <reg|heat|conserve|det|all> [seed]
