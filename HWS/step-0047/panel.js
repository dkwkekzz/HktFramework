/* step-0047 패널 — 에너지의 질(자유에너지·둘째 법칙, SPINE 여섯째 축). 직전 step-0044(3D 자기제한) 패널을 잇되 새 법칙 degrade + 노브 kQual 1개를 더했다.
 ...
 * 회귀: kQual=0 → degrade early-return = 직전 step(0044) 비트 동일(Eth 0·qualInit 미설정 → Eth 해시 skip). 렌더 L-Q(흑체 색온도)가 이 q 를 읽는다(RENDER §8 — 시뮬이 q 를 내보내야 색온도 author 0). 브라우저: window.HWS_PANEL_0047
