...
핵심은 **author 하지 않는다**는 것이다 — 아이템·캐릭터를 *타입으로 박아 넣는 것*이 아니라, 더 낮은 층위의 **규칙이 굴러간 결과로 창발**하게 한다.

## 핵심 한 줄

> **원소를 타입으로 박지 마라.** 세계엔 *원소*와 그 위에서 굴러가는 *규칙*만 있고, 아이템·캐릭터·상호작용은 모두 그 위에서 **창발**한다. 통일감은 author 하지 말고 굴려서 얻는다.
