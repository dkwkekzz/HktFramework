...
| # | 문서 | 한 줄 | 핵심 선행 |
|---|---|---|---|
| 00 | [00-foundations.md](00-foundations.md) | 선형대수 · 사원수 · 미적분 · 부동소수점·수치 안정성 (허브 + [00-foundations/](00-foundations/) 6개 세부 문서) | — |
| 01 | [01-kinematics.md](01-kinematics.md) | 운동 기술: 위치/속도/가속, 회전 표현, 좌표 변환 (허브 + [01-kinematics/](01-kinematics/) 9개 세부 문서) | 00 |
| 02 | [02-dynamics.md](02-dynamics.md) | 힘·토크·질량·관성텐서, Newton–Euler, 운동량 (허브 + [02-dynamics/](02-dynamics/) 9개 세부 문서) | 00·01 |
| 03 | [03-time-integration.md](03-time-integration.md) | ODE 적분기, 안정성/에너지 드리프트, 고정 timestep (허브 + [03-time-integration/](03-time-integration/) 9개 세부 문서) | 02 |
| 04 | [04-collision-detection.md](04-collision-detection.md) | broad/narrow phase, GJK/EPA/SAT, CCD, manifold (허브 + [04-collision-detection/](04-collision-detection/) 9개 세부 문서) | 00·11 |
| 05 | [05-constraint-solving.md](05-constraint-solving.md) | contact/friction, impulse·PGS·TGS, LCP, PBD/XPBD (허브 + [05-constraint-solving/](05-constraint-solving/) 9개 세부 문서) | 02·03·04 |
| 06 | [06-joints-articulation.md](06-joints-articulation.md) | 조인트, ragdoll, Featherstone 축소 좌표 (허브 + [06-joints-articulation/](06-joints-articulation/) 6개 세부 문서) | 05 |
| 07 | [07-deformable-bodies.md](07-deformable-bodies.md) | mass-spring, cloth, soft body, FEM (허브 + [07-deformable-bodies/](07-deformable-bodies/) 7개 세부 문서) | 03 |
| 08 | [08-fluids.md](08-fluids.md) | Eulerian/Lagrangian, SPH·PBF·FLIP, height-field (허브 + [08-fluids/](08-fluids/) 7개 세부 문서) | 03·11 |
| 09 | [09-particles.md](09-particles.md) | 파티클 시스템, force field, GPU 파티클 (허브 + [09-particles/](09-particles/) 6개 세부 문서) | 03 |
| 10 | [10-specialized-systems.md](10-specialized-systems.md) | character controller, vehicle, active ragdoll, 파괴 (허브 + [10-specialized-systems/](10-specialized-systems/) 7개 세부 문서) | 05·06 |
| 11 | [11-spatial-structures.md](11-spatial-structures.md) | BVH/DBVT, grid, 공간 해시, octree/BSP (허브 + [11-spatial-structures/](11-spatial-structures/) 6개 세부 문서) | 00 |
| 12 | [12-determinism-networking.md](12-determinism-networking.md) | fixed-point/float 결정론, lockstep/rollback, 서버 권위 (허브 + [12-determinism-networking/](12-determinism-networking/) 8개 세부 문서) | 03·05 |
| 13 | [13-performance-parallelism.md](13-performance-parallelism.md) | island/sleeping, SIMD, job system, GPU physics (허브 + [13-performance-parallelism/](13-performance-parallelism/) 8개 세부 문서) | 04·05 |
